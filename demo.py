    ...
    def load_models(self):
        try:
            ...
            if self.vectorizer and self.models:
                ...
                st.info(f"Loaded {len(self.models)} models: Logistic Regression, Random Forest, Gradient Boosting")
            else:
    ...
    def run(self):
        ...
        with tab3:
            ...
            if self.models:
                ...
                st.info("All models achieved high accuracy on training data.")
            else:
        ...
        with tab4:
            ...
            This application provides fast and accurate sentiment analysis for text data. It is designed for both individual and batch predictions, and supports multiple machine learning models for robust results.

            ### Features
            - **Multiple Models**: Logistic Regression, Random Forest, Gradient Boosting
            - **Batch & Single Analysis**: Analyze one or many texts at once
            - **Interactive Visualizations**: Pie and histogram charts for results
            - **Downloadable Results**: Export your analysis as CSV
            - **High Accuracy**: Models trained on a diverse, balanced dataset
            - **Modern UI**: Clean, professional interface

            ### How it Works
            1. **Preprocessing**: Cleans and normalizes text (lowercasing, lemmatization, stopword removal)
            2. **Feature Extraction**: Uses TF-IDF with trigrams for rich text representation
            3. **Prediction**: Select from top-performing models for sentiment classification
            ...
            - **Random Forest**: Robust to noise, handles complex patterns
            - **Gradient Boosting**: State-of-the-art accuracy for structured data

            ### Contact
            For support or integration, contact the developer or visit the project repository.
            """)
            if self.models:
